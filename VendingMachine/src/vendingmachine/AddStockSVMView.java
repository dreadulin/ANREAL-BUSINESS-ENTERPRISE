 ...
 */
public class AddStockSVMView extends javax.swing.JFrame {

    /**
     * Creates new form AddStockSVM
     */
    public AddStockSVMView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ADDING ITEMS TO SPECIAL VENDING MACHINE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddStockSVMView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddStockSVMView().setVisible(true);
            }
        });
    }
