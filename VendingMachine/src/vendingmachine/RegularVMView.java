...
/**
 * This class represents how the regular vending machine works (including its
 * features)
 *
...
public class RegularVMView extends javax.swing.JFrame {
    ...
    public JTable getChosenItemsTable() {
        return chosenItemsTable;
    }
    ...
    private void initComponents() {
        ...
        backBtn.setBackground(new java.awt.Color(254, 109, 115));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegularVMView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegularVMView().setVisible(true);
            }
        });
    }
