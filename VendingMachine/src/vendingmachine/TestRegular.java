 ...
 * @author Andrea
 */
public class TestRegular extends javax.swing.JFrame {

    /**
     * Creates new form TestRegular
     */
    public TestRegular() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestRegular.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TestRegular().setVisible(true);
            }
        });
    }
