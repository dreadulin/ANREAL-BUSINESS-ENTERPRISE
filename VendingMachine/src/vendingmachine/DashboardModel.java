...
public class DashboardModel {
    ...
    public boolean createSpecialVM(String machineName, int slotsQt, int itemSlotsQt) {
        boolean specialMachineExists = authenticatedOwner.getSpecialMachine(machineName) != null;
        ...
        SpecialVendingMachine newVendingMachine = new SpecialVendingMachine(authenticatedOwner, machineName, slotsQt, itemSlotsQt);
        authenticatedOwner.addMachine(newVendingMachine);
        return true;
    }
}
