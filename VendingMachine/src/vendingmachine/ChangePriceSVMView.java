...
/**
 * This class represents the changing of item price in the special vending
 * machine
 *
 * @author Andrea Dulin and Darryl Javier
 */
public class ChangePriceSVMView extends javax.swing.JFrame {

    /**
     * Creates new form ChangePriceSVM
     */
    public ChangePriceSVMView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangePriceSVMView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangePriceSVMView().setVisible(true);
            }
        });
    }
